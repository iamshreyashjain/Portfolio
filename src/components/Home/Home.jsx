                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <div>
                            <a href={ShreyashJain_Resume} download="ShreyashJain_Resume.pdf">
                                <button className='flex items-center justify-center px-6 py-3 my-4 cursor-pointer group hover:animate-pulse bg-gradient-to-tl from-gray-500 via-gray-700  to-stone-300 rounded-xl w-fit'>
                                    Download Resume
                                    <span className=''>
